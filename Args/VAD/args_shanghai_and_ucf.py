"""
Parameter setups for VAD data set: ShanghaiTech and UCF-Crime.
Node. Usually no need to change this file.
"""
...
parser.add_argument('--max-epoch', type=int, default=150, help='maximum iteration to train (default: 100)')
